/**
 * Brand-colored social icons (light background) for contact / marketing sections.
 */
export default function SocialBrandRow() {
  return (
    <div className="flex flex-wrap items-center justify-center gap-5 md:gap-7">
      <a
        ...
        aria-label="Facebook"
        className="flex h-11 w-11 items-center justify-center rounded-full bg-[#1877F2] text-white shadow-sm transition hover:opacity-90 md:h-12 md:w-12"
      >
      ...
      <a
        href="https://x.com/completeaiit"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="X"
        className="flex h-11 w-11 items-center justify-center rounded-full bg-black text-white shadow-sm transition hover:bg-neutral-800 md:h-12 md:w-12"
      >
      ...
      <a
        ...
        className="flex h-11 w-11 items-center justify-center rounded-full text-white shadow-sm transition hover:opacity-90 md:h-12 md:w-12 [background:linear-gradient(45deg,#f9ce34_0%,#ee2a7b_45%,#6228d7_100%)]"
      >
        <svg className="h-5 w-5" viewBox="0 0 24 24" aria-hidden>
          <path
            fill="currentColor"
      ...
      <a
        ...
        rel="noopener noreferrer"
        aria-label="YouTube"
        className="flex h-11 w-11 items-center justify-center rounded-full bg-[#FF0000] text-white shadow-sm transition hover:opacity-90 md:h-12 md:w-12"
      >
        <svg className="h-5 w-5" viewBox="0 0 24 24" aria-hidden>
          <path
            fill="currentColor"
